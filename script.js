document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      const label = (function () {
        const lbl = contactForm.querySelector('label[for="' + field.id + '"]');
    ...
    function showFieldError(field, message) {
      ...
      const errorId = (field.id || field.name || Math.random().toString(36).substr(2, 9)) + '-error';
      errorEl.id = errorId;
  ...
  const animationElements = document.querySelectorAll(OBSERVED_SELECTORS.join(', '));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '05e302c1-4fea-4076-bbd1-94bef38ed802',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '05e302c1-4fea-4076-bbd1-94bef38ed802';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '05e302c1-4fea-4076-bbd1-94bef38ed802';
